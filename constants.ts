...
export const MOCK_PACKAGES: PackageDetails[] = [
  {
    ...
    hotelMakkah: 'MOVENPICK HOTEL @ SETARAF (+-50 METER DARI DATARAN MASJIDIL HARAM)',
    hotelMadinah: 'NOZOL ROYAL INN HOTEL @ SETARAF (+-200 METER DARI DATARAN MASJID NABAWI)',
